...
public class TestBase {
    ...
    //we need these object for building reports, but it does not built itself
    ...
    public void testSetup(){
        //we are creating actual report
        report=new ExtentReports();
        //it is a path to the report itself
    ...
    public void teardown(ITestResult result){
        if(ITestResult.FAILURE == result.getStatus()) {
            ...
            //if test skipped,this information will be appear on the report
